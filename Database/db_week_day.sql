...
CREATE TABLE `week_day` (
  `idweek_day` int(11) NOT NULL AUTO_INCREMENT,
  `day` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idweek_day`)
...
INSERT INTO `week_day` VALUES (1,'Monday'),(2,'Tuesday'),(3,'Wednesday'),(4,'Thursday'),(5,'Friday'),(6,'Saturday');
...
-- Dump completed on 2013-05-20 13:14:16
