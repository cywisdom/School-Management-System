...
student_Id = (String) session.getAttribute("teacher_Id");
if(user_Id==null || !(userrole.equals("teacher")))
{	response.sendRedirect(request.getContextPath()+"/index.jsp");}
else if(student_Id==null)
{
	response.sendRedirect(request.getContextPath()+"/TeacherRegistration.jsp");
}
	...
	<div
		...
		<div style="position: absolute; right: 5%; top:15px;">
		...
		<div>
			<table class="headerMenu">
				<tr>
					<td height="20px" width="150px"><a class="menu" href=<%=request.getContextPath() +"/teacher_home.jsp"%>>Home</a></td>
					<td width="150px"><a class="menu" href=<%=request.getContextPath() +"/teacher_profile.jsp"%>>Profile</a></td>					
					<td width="150px"><a class="menu" href=<%=request.getContextPath() +"/t_attendance.jsp"%>>Manage Attendance</a></td>
				</tr>
				<tr>
					<td height="20px"><a class="menu" href=<%=request.getContextPath() +"/view_schedule.jsp"%>>Schedule</a></td>
					<td><a class="menu" href=<%=request.getContextPath() +"/teacher_graderp.jsp"%>>Manage Grade Report</a></td>					
					<td><a class="menu" href=<%=request.getContextPath() +"/teacher_changepass.jsp"%>>Change Password</a></td>
				</tr>
				<tr>
					<td height="20px"><a class="menu" href=<%=request.getContextPath() +"/teacher_docs.jsp"%>>Share Documents</a></td>
					<td><a class="menu" href=<%=request.getContextPath() +"/teacher_gallery.jsp"%>>Gallery</a></td>					
