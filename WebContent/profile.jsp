...
<%@ page import="org.sms.util.util"%>
	...
	<%
		...
		String query = "select * from student_mst where student_Id='"+ student_Id + "'";
		...
		query="select name from grade_mst where grade_Id='"+temp+"'";
	...
	<div class="shadow-div"
		...
		<table style="top: 20px; width:547px; position: absolute;" >
			...
			<tr>
				<td align="right">Standard:</td><td></td><td><%=standard %></td>
				<td></td>
			</tr>
			<tr>
