...
<body>
	...
	<div style="position: absolute; left: 15%; top: 230px;">
		<ul class="album">
			<% for(int i =0 ;i<albumname.size();i++){
			
				%>
					<li><a title="<%=albumname.get(i)%>" href="admin_album.jsp?an=<%=albumname.get(i)%>"> <img src="gallery/<%=imagepath.get(i)%>" alt="<%=albumname.get(i)%>" />
					</a></li>
				<%
	...
	<a href="<%=request.getContextPath()  + "/image_upload.jsp"%>" style="position: absolute; left: 20.5%; top: 175px;" class="button rounded green"> <span class="folder"></span> Create new album </a>
	<%conn.close(); %> 	
</body>
</html>