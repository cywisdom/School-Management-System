  ...
  <div  style="left: 13%; top: 100px; position: absolute;">
		...
		rs = stmt.executeQuery(query);
		   ...
		   {	String uploadtime = rs.getString("upload_time");
			   ...
			   %><tr><td><a target="_blank" href="student_download.jsp?file=<%=rs.getString("doc_name")%>"><%=rs.getString("title") %></a></td><td><%=rs.getString("fname") %> <%=rs.getString("lname") %></td><td><%=newDate%></td>      </tr><%
		   }	
